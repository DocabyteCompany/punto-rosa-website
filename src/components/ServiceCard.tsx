...
const ServiceCard: React.FC<ServiceCardProps> = ({
  ...
  return (
    <div className="bg-white rounded-2xl shadow-lg overflow-hidden hover:shadow-xl transition-all duration-300 hover:scale-105 group border border-neutral-warm-200 h-full flex flex-col min-h-[500px] m-0.5">
      ...
      <div className="p-5 flex-1 flex flex-col justify-between">
        <div>
          ...
          <p className="text-text-deep-600 text-sm mb-4 line-clamp-3">
        ...
        <button
          ...
          className="w-full text-white px-4 py-2.5 rounded-full text-sm font-medium transition-all duration-200 flex items-center justify-center shadow-lg hover:shadow-xl transform hover:scale-105"
          style={{
